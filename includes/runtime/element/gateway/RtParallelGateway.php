...
/**
 * @Table(name: "wfs_rt_element_parallel_gateway")
 * @BaseEntity(name: "Workflows\Runtime\Element\Gateway\RtGateway")
 */
final class RtParallelGateway extends RtGateway {
    /**
     * @throws MWException
     */
            ...
            case GatewayDirection::Converging:
                ...
                foreach ( $tokens as $token ) {
                    if ( is_null( $initiator ) ) {
                        ...
                        if ( !(
                            $initiator instanceof RtParallelGateway &&
                            ...
                            throw new MWException(
                                ...
                                "parallel gateway has its initiator element be not diverging parallel gateway. " .
    ...
    public function end() : void {
        switch ( $this->getDirection() ) {
            case GatewayDirection::Diverging:
                ...
                $succeeding = $this->getWorkflow()->findElementsSucceedingTo( $this );
