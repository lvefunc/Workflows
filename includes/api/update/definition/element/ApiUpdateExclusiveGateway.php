...
final class ApiUpdateExclusiveGateway extends ApiUpdateElementBase {
    /**
     * @inheritDoc
    ...
    public function execute() {
        ...
        $exclusiveGateway = $unitOfWork->findByID( ExclusiveGateway::class, $params["id"] );

        if ( isset( $params["name"] ) ) {
            $exclusiveGateway->setWord( $params["name"] );
        }
        ...
        if ( isset( $params["direction"] ) ) {
            $exclusiveGateway->setDirection( GatewayDirection::valueOf( $params["direction"] ) );
        }
