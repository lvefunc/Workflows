...
final class ApiCreateInclusiveGateway extends ApiCreateElementBase {
    /**
     * @inheritDoc
    ...
    public function execute() {
        ...
        $inclusiveGateway = new InclusiveGateway( $params["name"], GatewayDirection::valueOf( $params["direction"] ) );
